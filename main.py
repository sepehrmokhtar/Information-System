...
class PatientMedInfo(db.Model):
    ...
    immunization_status = db.Column('immunization_status', db.Text, nullable=True)
    ...
    smoking_history = db.Column('smoking_history', db.String(4), nullable=False)
    alcoholic = db.Column('alcoholic', db.String(4), nullable=False)
    ...
    def __init__(self, patient_id, height, weight, heart_rate, respiratory_rate, core_temperature,
        ...
        self.immunization_status = immunization_status
